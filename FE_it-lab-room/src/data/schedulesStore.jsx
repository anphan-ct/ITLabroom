...
function normalizeSchedule(schedule) {
  ...
  return {
    ...schedule,
    studyDate: schedule.studyDate || schedule.date || "2026-06-08",
    weekNumber: Number(schedule.weekNumber || schedule.week_number || 1),
    day: schedule.day || schedule.weekday || "Thứ 2",
    shift: schedule.shift || "Ca sáng",
    ...
    scheduleType: schedule.scheduleType || schedule.schedule_type || "ChinhThuc",
