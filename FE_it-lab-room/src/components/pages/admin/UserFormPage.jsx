...
export default function UserFormPage({ defaultRole = "Sinh viên" }) {
  ...
  const handleSubmit = async (event) => {
    ...
    if (isStudentRole) {
      ...
      payload.ma_lop = formData.ma_lop ? Number(formData.ma_lop) : "";
    ...
    if (isTeacherRole) {
      ...
      payload.ma_phong_ban = formData.ma_phong_ban ? Number(formData.ma_phong_ban) : "";
    }
