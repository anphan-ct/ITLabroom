  ...
  admin: [
    ...
    { to: "/admin/schedules", label: "Lịch phòng máy", icon: CalendarDays },
    {
      ...
      children: [
        ...
        { to: "/admin/loan-details", label: "Chi tiết mượn", icon: ClipboardList },
      ],
    },
    {
      to: "/admin/computer-returns",
      label: "Trả máy",
      icon: RotateCcw,
      children: [
        { to: "/admin/computer-returns", label: "Phiếu trả máy", icon: RotateCcw },
        { to: "/admin/computer-return-details", label: "Chi tiết trả", icon: ClipboardList },
      ],
    },
